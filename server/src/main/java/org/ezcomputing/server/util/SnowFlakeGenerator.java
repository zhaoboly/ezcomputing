...
public class SnowFlakeGenerator {
	...
	//customized uuid, add 4 random character to prevent guessing
	public synchronized String nextUUID() {
		long id = nextId();
		
		String randomPostfix = RandomStringUtils.randomAlphanumeric(6);
		
		String uuid = String.valueOf(id)+ randomPostfix;
